...
namespace Ass1
{
    ...
    //Builder for withdraw
    public class W_transactionBuilder : TransactionBuilder
    {
        public W_transactionBuilder()
        {
        }
        ...
        {
            transaction.TransactionType = (char)TransactionType.Withdrawal;
        }
    }
}
